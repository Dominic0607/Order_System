    ...
    return (
        <div className="space-y-10">
            <div className="flex items-center gap-4 border-b border-[#1A1A1A] pb-6">
                ...
                <div>
                    <h3 className="text-lg font-black text-[#EAECEF] uppercase tracking-[0.2em]">Protocol Simulation Lab</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-4">
                    <div className="flex items-center gap-2 mb-1">
                        ...
                        <label className="text-[9px] font-black text-[#707A8A] uppercase tracking-[0.2em]">Input Stress Test</label>
                    </div>
