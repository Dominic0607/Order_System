...
const ConfigEditModal: React.FC<ConfigEditModalProps> = ({ section, item, onClose, onSave }) => {
    ...
    if (section.id === 'users') {
        ...
        return (
                    ...
                    <div className="overflow-y-auto no-scrollbar flex-grow px-6 py-5 space-y-5">
                        ...
                        <div className="flex items-center gap-5">
                            ...
                            <div className="relative flex-shrink-0 group">
                                ...
                                <input type="file" accept="image/png, image/jpeg, image/webp" ref={el => { fileInputRefs.current['ProfilePictureURL'] = el; }} onChange={(e) => e.target.files && handleImageUpload('ProfilePictureURL', e.target.files[0])} className="hidden" />
                            </div>
            ...
            {/* ── Image Cropper Modal (must be outside <Modal> so z-index stacks correctly) ── */}
