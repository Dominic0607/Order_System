    ...
    <div className="flex flex-col xl:flex-row gap-12 items-center justify-center w-full min-h-[600px]">
      <div className="flex flex-col gap-6 items-center label-preview-container flex-1 w-full max-w-[420px]">
        <div className={`relative group transition-all duration-300 w-full flex justify-center ${isDesignMode ? 'scale-100' : 'hover:scale-[1.02]'}`}>
            <div className={`absolute -inset-1 rounded-sm blur opacity-25 group-hover:opacity-50 transition duration-500 ${isFlexi ? 'bg-amber-500' : 'bg-[#FCD535]'}`}></div>
            <div className="relative w-full bg-[#181A20] border border-[#2B3139] p-6 rounded-sm flex flex-col items-center shadow-2xl overflow-hidden">
                 {isDesignMode && (
                    <div className="absolute top-2 left-1/2 -translate-x-1/2 bg-[#FCD535]/20 text-[#FCD535] border border-[#FCD535]/30 px-3 py-1 rounded-sm text-[9px] font-bold uppercase tracking-widest flex items-center gap-2 z-20 animate-pulse">
            ...
            <div className="relative w-full bg-[#181A20] border border-[#2B3139] p-6 rounded-sm flex flex-col items-center shadow-2xl">
                <div className={`relative bg-white transition-all duration-300 ${isDesignMode ? 'ring-2 ring-[#FCD535] ring-offset-4 ring-offset-[#181A20]' : 'shadow-[0_0_30px_rgba(255,255,255,0.05)]'}`}>
                 ...
                 <div className="mt-6 w-full flex justify-between items-center text-xs font-mono text-gray-500 no-print">
                    ...
                    <div className="text-[#FCD535] font-bold tracking-widest">ACTIVE</div>
                 </div>
            </div>
        </div>
      </div>
