 ...
 * limitations under the License.
 * =============================================================================
 */function Cu(n,e,t,s){if(s==="int32"){const o=Int32Array.from(n);return[e,"int32",o]}if(s==="bool"){const o=Uo([0],t),[r,a]=j((c,i)=>c!==i?1:0)(e,[],n,o,"bool");return[a,"bool",r]}throw new Error(`Error in Cast: failed to cast ${t} to ${s}`)}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function ku(n,e,t,s,o,r,a,c,i){const l=X([s,r],t);for(let u=0;u<s;u++){const d=[];let p=0;for(let h=0;h<o;h++){const f=n[u*o+h];p+=f*a[h],d.push(f)}if(p<0||p>=i/r)throw new Error(`Invalid indices: ${d} does not index into ${c}`);for(let h=0;h<r;h++)l.values[u*r+h]=e.get(...e.indexToLoc(p*r+h))}return l}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ou(n,e,t){const s=X(t,n.dtype);for(let o=0;o<s.size;++o){const a=s.indexToLoc(o).slice(),c=a[0],i=a[2],l=e.locToIndex([c,i]);a[2]=e.values[l];const u=n.locToIndex(a);0<=u&&u<n.values.length&&(s.values[o]=n.values[u])}return s}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function _u(n,e,t){const s=(e-n)/(t-1),o=tt(t,"float32");o[0]=n;for(let r=1;r<o.length;r++)o[r]=o[r-1]+s;return o}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Bu(n,e,t,s){const o=ye(s,T(t));for(let r=0;r<o.length;++r){const a=r*e;let c=n[a];for(let i=0;i<e;++i){const l=n[a+i];(Number.isNaN(l)||l>c)&&(c=l)}o[r]=c}return o}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Wu(n,e,t){const s=Ve(-1,t);return to([],e,s,n,t)}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Gu(n,e,t,s,o){const r=e.length,a=T(e),c=te(e),i=te(o),l=ye(t,T(o));for(let u=0;u<a;++u){const d=en(u,r,c),p=new Array(d.length);for(let f=0;f<p.length;f++)p[f]=d[s[f]];const h=zt(p,r,i);l[h]=n[u]}return l}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function zu(n,e,t,s){const[o,r]=pe(n,s),a=Ie(e,"int32"),c=tt(T(o),a),i=T(r);for(let l=0;l<c.length;++l){const u=l*i;let d=1;for(let p=0;p<i;++p)d*=t[u+p];c[l]=d}return{outVals:c,outShape:o,outDtype:a}}/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */function ed(n,e,t,s){const o=n===e,r=n<e&&t<0,a=e<n&&t>1;if(o||r||a)return tt(0,s);const c=Math.abs(Math.ceil((e-n)/t)),i=tt(c,s);e<n&&t===1&&(t=-1),i[0]=n;for(let l=1;l<i.length;l++)i[l]=i[l-1]+t;return i}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function nd(n,e,t,s,o,r,a,c,i,l){const u=[s/o,o],d=n.values,p=e.values;if(s===0)return X(t,e.dtype);const h=i instanceof Ht?i:X(u,e.dtype);typeof i=="string"||typeof i=="number"?h.values.fill(i):typeof i=="boolean"&&h.values.fill(+i);for(let f=0;f<r;f++){const g=[];let x=0;for(let m=0;m<a;m++){const C=d[f*a+m];g.push(C),x+=C*c[m]}if(x<0||x>=s/o)throw new Error(`Invalid indices: ${g} does not index into ${t}`);for(let m=0;m<o;m++)l?h.values[x*o+m]+=p[f*o+m]:h.values[x*o+m]=e.rank===0?p[0]:p[f*o+m]}return h}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function od(n,e,t,s,o){const r=os(s,e,t),a=T(t),c=te(s);if(r){const d=rs(e,c);return o==="string"?n.slice(d,d+a):n.subarray(d,d+a)}const i=o==="string"?nt(n):n,l=X(s,o,i),u=X(t,o);for(let d=0;d<u.size;++d){const p=u.indexToLoc(d),h=p.map((f,g)=>f+e[g]);u.set(l.get(...h),...p)}return o==="string"?jo(u.values):u.values}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function id(n,e,t,s,o,r=!1,a=0){const c=s.length,i=[e[0],n.length/e[0]],l=i[1],d=c>0?o[c-1]+1:0;if(d<0)throw new Error(yn());const p=e.slice();p[0]=d;const h=p.reduce((b,v)=>b*v,1),f=V(t,h);if(c===0)return d>0&&f.fill(a),[f,p];if(d<=0)throw new Error(yn());let g=0,x=1,m=0,C=o[g];for(;;){let b=0;if(x<c){if(b=o[x],C===b){++x;continue}if(C>=b)throw new Error(sr())}if(C<0||C>=d)throw new Error(or(C,d));C>m&&f.fill(a,m*l,C*l);for(let v=g;v<x;++v){const w=s[v];if(w<0||w>=i[0])throw new Error(rr(v,s[v],i[0]));for(let N=0;N<l;N++)f[C*l+N]+=n[w*l+N]}if(r)for(let v=0;v<l;v++)f[C*l+v]/=x-g;if(g=x,++x,m=C+1,C=b,x>c)break}return m<d&&f.fill(a,m*l,d*l),[f,p]}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const ld=j(((n,e)=>{const t=n-e;return t*t}));/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const ud=fe((n,e)=>{const{pattern:t,replaceGlobal:s,rewrite:o}=e;return n.replace(new RegExp(t,s?"g":""),o)});/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function dd(n,e,t,s){const o=X(n,e.dtype);for(let r=0;r<o.size;r++){const a=o.indexToLoc(r),c=new Array(a.length);for(let i=0;i<c.length;i++)c[i]=a[i]*t[i]+s[i];o.set(e.get(...c),...a)}return o}/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function xd(n,e){const t=V("int32",n.length);for(let s=0;s<n.length;++s)t[s]=ar(n[s]).modulo(e).getLowBitsUnsigned();return t}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Cd(n,e){const t=new Array(n.rank);for(let o=0;o<t.length;o++)t[o]=n.shape[o]*e[o];const s=X(t,n.dtype);for(let o=0;o<s.values.length;++o){const r=s.indexToLoc(o),a=new Array(n.rank);for(let i=0;i<a.length;i++)a[i]=r[i]%n.shape[i];const c=n.locToIndex(a);s.values[o]=n.values[c]}return s}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function ao(n,e){return["x","y","z","w","u","v"].slice(0,e).map(t=>`${n}.${t}`)}function M(n,e){return e===1?[n]:ao(n,e)}function hp(n,e){if(n===1)return"rc";let t="";for(let s=0;s<n;s++)t+=e[s],s<n-1&&(t+=",");return t}/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class fp{constructor(e){if(this.variableNames=["A"],this.packedInputs=!1,this.packedOutput=!0,this.outputShape=e,this.rank=e.length,this.enableShapeUniforms=U(this.outputShape.length),this.rank===0)this.userCode=`
        void main() {
...
`,ge="return x;",Sp="return 1.0 / (1.0 + exp(-1.0 * x));";/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Vp(){$().set("WEBGL_FORCE_F16_TEXTURES",!0)}/**
 * @license
 ...
 * limitations under the License.
 * =============================================================================
 */mr()&&xr("webgl",()=>new At,2);const Eb={forceHalfFloat:Vp};/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Q(n){const{inputs:e,backend:t}=n,{x:s}=e;return t.incRef(s.dataId),{dataId:s.dataId,shape:s.shape,dtype:s.dtype}}const Up={kernelName:gr,backendName:"webgl",kernelFunc:Q};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function $e(n){const{inputs:e,backend:t}=n,{real:s,imag:o}=e,r=t.makeTensorInfo(s.shape,"complex64"),a=t.texData.get(r.dataId),c=Q({inputs:{x:s},backend:t}),i=Q({inputs:{x:o},backend:t});return a.complexTensorInfos={real:c,imag:i},r}const Wp={kernelName:Cr,backendName:"webgl",kernelFunc:$e};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */const uo="return (a < 0.) ? b * a : a;",po=`
  vec4 aLessThanZero = vec4(lessThan(a, vec4(0.)));
  return (aLessThanZero * (b * a)) + ((vec4(1.0) - aLessThanZero) * a);
`;function zp(n){const{inputs:e,backend:t}=n,{x:s,alpha:o}=e,r=$().getBool("WEBGL_PACK_BINARY_OPERATIONS")?new Xe(po,s.shape,o.shape):new Ne(uo,s.shape,o.shape);return t.runWebGLProgram(r,[s,o],"float32")}const Hp={kernelName:br,backendName:"webgl",kernelFunc:zp};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Kp(n,e,t){const s=[Te(n.shape),...Ee(n.shape)],o={dtype:n.dtype,shape:s,dataId:n.dataId},r=[Te(e),...Ee(e)],a=new io(r,s),c=!0,i=[s],l=t.runWebGLProgram(a,[o],n.dtype,i,c);return{dataId:l.dataId,shape:e,dtype:l.dtype}}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class Qp{constructor(e,t){this.variableNames=["A"];const s=new Array(e.length);for(let a=0;a<s.length;a++)s[a]=e[t[a]];this.outputShape=s,this.rank=s.length;const o=D(this.rank),r=Zp(t);this.userCode=`
    void main() {
 ...
 * limitations under the License.
 * =============================================================================
 */function Ft(n,e,t){const s=$().getBool("WEBGL_PACK_ARRAY_OPERATIONS")?new Jp(n.shape,e):new Qp(n.shape,e);return t.runWebGLProgram(s,[n],n.dtype)}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function eh(n,e,t,s){const o=e,r=n.shape.length,a=K(o,n.shape);let c=a;const i=ie(c,r),l=i!=null;let u=n;l&&(u=Ft(n,i,s),c=ce(c.length,r)),de("sum",c,r);const[d,p]=pe(u.shape,c);let h=d;t&&(h=ve(d,a));const f=T(p),x=T(n.shape)/f,m=R({inputs:{x:u},attrs:{shape:[x,f]},backend:s}),C=sn(n.dtype),b=Ae(m,C,"sum",s),v=R({inputs:{x:b},attrs:{shape:h},backend:s});return s.disposeIntermediateTensorInfo(m),s.disposeIntermediateTensorInfo(b),l&&s.disposeIntermediateTensorInfo(u),v}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function _t(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:r,keepDims:a}=s;return eh(o,r,a,t)}const th={kernelName:yr,backendName:"webgl",kernelFunc:_t};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function sh(n){const{inputs:e,backend:t,attrs:s}=n,{a:o,b:r,bias:a,preluActivationWeights:c}=e,{transposeA:i,transposeB:l,activation:u,leakyreluAlpha:d}=s;return Tt({a:o,b:r,transposeA:i,transposeB:l,backend:t,bias:a,preluActivationWeights:c,leakyreluAlpha:d,activation:u})}const oh={kernelName:Tr,backendName:"webgl",kernelFunc:sh};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Mn="return abs(x);";function rh(n){const{inputs:e,backend:t}=n,{x:s}=e;if(t.shouldExecuteOnCPU([s])&&s.dtype!=="complex64"){const r=t.texData.get(s.dataId),a=oo(r.values);return t.makeTensorInfo(s.shape,s.dtype,a)}let o;return $().getBool("WEBGL_PACK_UNARY_OPERATIONS")?o=new Ce(s.shape,Mn):o=new ue(s.shape,Mn),t.runWebGLProgram(o,[s],s.dtype)}const ah={kernelName:Er,backendName:"webgl",kernelFunc:rh};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */const ih=oe+`
  ...
  return acos(x);
`,ch=P({opSnippet:ih}),lh={kernelName:Nr,backendName:"webgl",kernelFunc:ch};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */const uh=oe+`
  if (x < 1.0) return NAN;
return log(x + sqrt(x * x - 1.0));`,dh=P({opSnippet:uh}),ph={kernelName:kr,backendName:"webgl",kernelFunc:dh};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Gn="return a + b;",hh=B({opSnippet:Gn,packedOpSnippet:Gn,supportsComplex:!0,cpuKernelImpl:wd}),fh={kernelName:Or,backendName:"webgl",kernelFunc:hh};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class mh{constructor(e,t){this.outputShape=[],this.outputShape=e,this.variableNames=t.map((r,a)=>`T${a}`);const s=[];this.variableNames.forEach(r=>{s.push(`float v${r} = get${r}AtOutCoords();`)});const o=this.variableNames.map(r=>`v${r}`).join(" + ");this.userCode=`
      void main() {
        ${s.join(`
        `)}
 ...
 * limitations under the License.
 * =============================================================================
 */function Ch(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:r,keepDims:a}=s,c=o.shape.length,i=K(r,o.shape);let l=i;const u=ie(l,c);let d=o;u!=null&&(d=G({inputs:{x:o},backend:t,attrs:{perm:u}}),l=ce(l.length,c)),de("all",l,c);const[p,h]=pe(d.shape,l),f=T(h),g=R({inputs:{x:d},backend:t,attrs:{shape:[-1,f]}}),x=Ae(g,g.dtype,"all",t);let m;if(a){const C=ve(p,i);m=R({inputs:{x},backend:t,attrs:{shape:C}})}else m=R({inputs:{x},backend:t,attrs:{shape:p}});return t.disposeIntermediateTensorInfo(g),t.disposeIntermediateTensorInfo(x),u!=null&&t.disposeIntermediateTensorInfo(d),m}const vh={kernelName:Dr,backendName:"webgl",kernelFunc:Ch};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function bh(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:r,keepDims:a}=s,c=o.shape.length,i=K(r,o.shape);let l=i;const u=ie(l,c);let d=o;u!=null&&(d=G({inputs:{x:o},backend:t,attrs:{perm:u}}),l=ce(l.length,c)),de("any",l,c);const[p,h]=pe(d.shape,l),f=T(h),g=R({inputs:{x:d},backend:t,attrs:{shape:[-1,f]}}),x=Ae(g,g.dtype,"any",t);let m;if(a){const C=ve(p,i);m=R({inputs:{x},backend:t,attrs:{shape:C}})}else m=R({inputs:{x},backend:t,attrs:{shape:p}});return t.disposeIntermediateTensorInfo(g),t.disposeIntermediateTensorInfo(x),u!=null&&t.disposeIntermediateTensorInfo(d),m}const $h={kernelName:Ar,backendName:"webgl",kernelFunc:bh};/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class wh{constructor(e,t,s){this.variableNames=["A"];const{windowSize:o,batchSize:r,outSize:a}=e;s||this.variableNames.push("bestIndicesA"),this.outputShape=[r,a];const c=t==="max"?">":"<",i=s?"inOffset + i;":"round(getBestIndicesA(batch, inOffset + i));";this.userCode=`
      void main() {
        ivec2 coords = getOutputCoords();
        int batch = coords[0];
        int outIdx = coords[1];
 ...
 * limitations under the License.
 * =============================================================================
 */function Sh(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:r}=s;let a=K(r,o.shape);const c=ie(a,o.shape.length);let i=o;const l=[];c!=null&&(i=G({inputs:{x:o},backend:t,attrs:{perm:c}}),l.push(i),a=ce(a.length,i.shape.length)),de("argMax",[a[0]],i.shape.length);const u=go(t,i,a[0],"max");return l.forEach(d=>t.disposeIntermediateTensorInfo(d)),u}const yh={kernelName:Fr,backendName:"webgl",kernelFunc:Sh};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Ih(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:r}=s;let a=K(r,o.shape);const c=ie(a,o.shape.length);let i=o;const l=[];c!=null&&(i=G({inputs:{x:o},backend:t,attrs:{perm:c}}),l.push(i),a=ce(a.length,i.shape.length)),de("argMin",[a[0]],i.shape.length);const u=go(t,i,a[0],"min");return l.forEach(d=>t.disposeIntermediateTensorInfo(d)),u}const Th={kernelName:_r,backendName:"webgl",kernelFunc:Ih};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */const Eh=oe+`
  ...
  return asin(x);
`,Nh=P({opSnippet:Eh}),kh={kernelName:Lr,backendName:"webgl",kernelFunc:Nh};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Oh=oe+"return log(x + sqrt(x * x + 1.0));",Ph=P({opSnippet:Oh}),Dh={kernelName:Br,backendName:"webgl",kernelFunc:Ph};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */const Ah=oe+`
  return atan(x);
`,Fh=P({opSnippet:Ah}),_h={kernelName:Vr,backendName:"webgl",kernelFunc:Fh};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,Bh=`
  ...
  `+De+`
  return result;
`,Vh=B({opSnippet:Lh,packedOpSnippet:Bh}),Uh={kernelName:Ur,backendName:"webgl",kernelFunc:Vh};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
return (log(1.0 + x) - log(1.0 - x)) / 2.0;`,Mh=P({opSnippet:Wh}),Gh={kernelName:Wr,backendName:"webgl",kernelFunc:Mh};/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Xh(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{filterSize:r,strides:a,pad:c,dimRoundingMode:i,dataFormat:l}=s,u=[1,1,1],d=Ot(o.shape,r,a,u,c,i,l),p=new bn(d,"avg",!1);return t.runWebGLProgram(p,[o],"float32")}const Kh={kernelName:Gr,backendName:"webgl",kernelFunc:Xh};/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class jh{constructor(e){this.variableNames=["dy"],this.outputShape=e.inShape;const t=e.filterHeight,s=e.filterWidth,o=e.strideHeight,r=e.strideWidth,a=e.dilationHeight,c=e.dilationWidth,i=e.effectiveFilterHeight,l=e.effectiveFilterWidth,u=i-1-e.padInfo.top,d=l-1-e.padInfo.left,p=1/(t*s);this.userCode=`
 ...
 * limitations under the License.
 * =============================================================================
 */function Yh(n){const{inputs:e,backend:t,attrs:s}=n,{dy:o,input:r}=e,a=r,{filterSize:c,strides:i,pad:l,dimRoundingMode:u}=s,d=[1,1,1],p=Ot(a.shape,c,i,d,l,u),h=new qh(p);return t.runWebGLProgram(h,[o],a.dtype)}const Qh={kernelName:zr,backendName:"webgl",kernelFunc:Yh};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Zh(n){const{inputs:e,backend:t,attrs:s}=n,{dy:o,input:r}=e,a=r;We([o,r],"avgPoolGrad");const{filterSize:c,strides:i,pad:l}=s,u=lt(a.shape,c,i,1,l),d=new jh(u);return t.runWebGLProgram(d,[o],a.dtype)}const Jh={kernelName:Hr,backendName:"webgl",kernelFunc:Zh};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function ef(n){const{inputs:e,backend:t,attrs:s}=n,{a:o,b:r}=e,{transposeA:a,transposeB:c}=s;return Tt({a:o,b:r,transposeA:a,transposeB:c,backend:t})}const tf={kernelName:Xr,backendName:"webgl",kernelFunc:ef};/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class nf{constructor(e,t,s,o,r,a){this.outputShape=[],this.variableNames=["x","mean","variance"],Y(e,t),Y(e,s);let c="0.0";o!=null&&(Y(e,o),this.variableNames.push("offset"),c="getOffsetAtOutCoords()");let i="1.0";r!=null&&(Y(e,r),this.variableNames.push("scale"),i="getScaleAtOutCoords()"),this.outputShape=e,this.userCode=`
      void main() {
 ...
 * limitations under the License.
 * =============================================================================
 */const of=({inputs:n,backend:e,attrs:t})=>{const{x:s,mean:o,variance:r,offset:a,scale:c}=n;F(o.shape.length===r.shape.length,()=>"Batch normalization gradient requires mean and variance to have equal ranks."),F(a==null||o.shape.length===a.shape.length,()=>"Batch normalization gradient requires mean and offset to have equal ranks."),F(c==null||o.shape.length===c.shape.length,()=>"Batch normalization gradient requires mean and scale to have equal ranks.");let{varianceEpsilon:i}=t;i==null&&(i=.001);const l=[s,o,r];let u=null;a!=null&&(u=a.shape,l.push(a));let d=null;c!=null&&(d=c.shape,l.push(c));const p=$().getBool("WEBGL_PACK_NORMALIZATION")?new sf(s.shape,o.shape,r.shape,u,d,i):new nf(s.shape,o.shape,r.shape,u,d,i);return e.runWebGLProgram(p,l,l[0].dtype)},rf={kernelName:Kr,backendName:"webgl",kernelFunc:of};/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class af{constructor(e){this.variableNames=["source"],this.outputShape=e,this.rank=e.length;const t=D(this.rank);this.customUniforms=[{name:"start",arrayIndex:this.rank,type:"int"}];const s=cf(this.rank);let o;const r=e.map((a,c)=>`sourceLoc.${Yt[c]} = start[${c}] + coords.${Yt[c]};`);o=`
        ${t} sourceLoc;
...
`)}
    ...
    `}}const Yt=["x","y","z","w","u","v"];function cf(n){if(n===1)return"sourceLoc";if(n<=6)return Yt.slice(0,n).map(e=>"sourceLoc."+e).join(",");throw Error(`Slicing for rank ${n} is not yet supported`)}/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const pf=n=>{const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{blockShape:r,crops:a}=s;F(o.shape.length<=4,()=>"batchToSpaceND for rank > 4 with a WebGL backend not implemented yet");const c=r.reduce((C,b)=>C*b),i=as(o.shape,r,c),l=is(i.length,r.length),u=cs(o.shape,r,c),d=Zr(a,r.length),p=Jr(u,a,r.length),h=[],f=R({inputs:{x:o},backend:t,attrs:{shape:i}}),g=G({inputs:{x:f},backend:t,attrs:{perm:l}}),x=R({inputs:{x:g},backend:t,attrs:{shape:u}}),m=je({inputs:{x},backend:t,attrs:{begin:d,size:p}});return h.push(f),h.push(g),h.push(x),h.forEach(C=>t.disposeIntermediateTensorInfo(C)),m},hf={kernelName:Qr,backendName:"webgl",kernelFunc:pf};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function ff(n){const{inputs:e,backend:t,attrs:s}=n,{x:o,weights:r}=e,{size:a}=s,c=t.readSync(o.dataId),i=t.readSync(r.dataId),l=so(c,i,r.dtype,r.shape,a);return t.makeTensorInfo([a],r.dtype,l)}const mf={kernelName:ea,backendName:"webgl",kernelFunc:ff};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function bf(n){const{inputs:e,backend:t}=n,{s0:s,s1:o}=e,r=t.readSync(s.dataId),a=t.readSync(o.dataId),c=Y(Array.from(r),Array.from(a));return t.makeTensorInfo([c.length],"int32",Int32Array.from(c))}const $f={kernelName:na,backendName:"webgl",kernelFunc:bf};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const wf="return float(a != b);",Co=B({opSnippet:wf,cpuKernelImpl:Hd,dtype:"bool"}),Rf={kernelName:sa,backendName:"webgl",kernelFunc:Co};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function pt(n){const{inputs:e,backend:t}=n,{input:s}=e,o=t.texData.get(s.dataId);return Q({inputs:{x:o.complexTensorInfos.real},backend:t})}const Sf={kernelName:oa,backendName:"webgl",kernelFunc:pt};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const yf="return float(int(x));";function If(n,e){const t=new ue(n.shape,yf),s=e.runWebGLProgram(t,[n],"int32");return{dataId:s.dataId,shape:s.shape,dtype:s.dtype}}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Qt(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{dtype:r}=s;if(r==="complex64"){if(o.dtype==="complex64")return Q({inputs:{x:o},backend:t});const a=aa(o.shape),c=Qt({inputs:{x:o},backend:t,attrs:{dtype:"float32"}}),i=$e({inputs:{real:c,imag:a},backend:t});return a.dispose(),t.disposeIntermediateTensorInfo(c),i}if(o.dtype==="complex64"){const a=pt({inputs:{input:o},backend:t}),c=Qt({inputs:{x:a},backend:t,attrs:{dtype:r}});return t.disposeIntermediateTensorInfo(a),c}if(!ia(o.dtype,r)){const a=Q({inputs:{x:o},backend:t});return{dataId:a.dataId,shape:a.shape,dtype:r}}if(t.shouldExecuteOnCPU([o])){const a=t.texData.get(o.dataId).values,[c,i,l]=yd(a,o.shape,o.dtype,r);return t.makeTensorInfo(c,i,l)}if(r==="int32")return If(o,t);if(r==="bool"){const a=t.makeTensorInfo([],"bool",ye("bool",1)),i=Co({inputs:{a:o,b:a},backend:t});return t.disposeIntermediateTensorInfo(a),i}throw new Error(`Error in Cast: failed to cast ${o.dtype} to ${r}`)}const Tf={kernelName:ra,backendName:"webgl",kernelFunc:Qt};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const zn="return ceil(x);",Ef=P({opSnippet:zn,packedOpSnippet:zn,cpuKernelImpl:Id}),Nf={kernelName:ca,backendName:"webgl",kernelFunc:Ef};/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Pf(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{clipValueMin:r,clipValueMax:a}=s;let c;$().getBool("WEBGL_PACK_CLIP")?c=new Of(o.shape):c=new kf(o.shape);const i=[[r],[a]];return t.runWebGLProgram(c,[o],o.dtype,i)}const Df={kernelName:la,backendName:"webgl",kernelFunc:Pf};/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class Af{constructor(e){this.variableNames=["real","imag"],this.outputShape=e,this.userCode=`
      void main() {
 ...
 * limitations under the License.
 * =============================================================================
 */function Lt(n){const{inputs:e,backend:t}=n,{input:s}=e,o=t.texData.get(s.dataId);return Q({inputs:{x:o.complexTensorInfos.imag},backend:t})}const Vf={kernelName:da,backendName:"webgl",kernelFunc:Lt};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class Xf{constructor(e){this.variableNames=["x","dy"],this.outputShape=e.filterShape;const t=e.strideHeight,s=e.strideWidth,o=e.padInfo.top,r=e.padInfo.left,a=e.dataFormat==="channelsLast";this.userCode=`
      void main() {
        ivec4 coords = getOutputCoords();
        int wR = coords.x;
        int wC = coords.y;
 ...
 * limitations under the License.
 * =============================================================================
 */function Yf(n){const{inputs:e,backend:t,attrs:s}=n,{x:o,dy:r}=e,{strides:a,pad:c,dataFormat:i,dimRoundingMode:l,filterShape:u}=s,d=Pt(i),p=be(o.shape,u,a,1,c,l,!1,d),h=new Xf(p);return t.runWebGLProgram(h,[o,r],"float32")}const Qf={kernelName:ma,backendName:"webgl",kernelFunc:Yf};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function tm(n){const{inputs:e,backend:t,attrs:s}=n,{x:o,filter:r}=e,{strides:a,pad:c,dilations:i}=s,l=on(o.shape,r.shape,a,i,c),u=new Mf(l);return t.runWebGLProgram(u,[o,r],"float32")}const nm={kernelName:ga,backendName:"webgl",kernelFunc:tm};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function sm(n){const{inputs:e,backend:t,attrs:s}=n,{x:o,dy:r}=e,{strides:a,pad:c,filterShape:i}=s,l=on(o.shape,i,a,1,c),u=new jf(l);return t.runWebGLProgram(u,[o,r],"float32")}const om={kernelName:Ca,backendName:"webgl",kernelFunc:sm};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function rm(n){const{inputs:e,backend:t,attrs:s}=n,{dy:o,filter:r}=e,{pad:a,strides:c,inputShape:i}=s,l=on(i,r.shape,c,1,a),u=new qf(l);return t.runWebGLProgram(u,[o,r],"float32")}const am={kernelName:va,backendName:"webgl",kernelFunc:rm};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,cm=`
  ...
  ${De}
  return result;
`,lm=P({opSnippet:im,packedOpSnippet:cm}),um={kernelName:ba,backendName:"webgl",kernelFunc:lm};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,pm=P({opSnippet:dm}),hm={kernelName:$a,backendName:"webgl",kernelFunc:pm};/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function gm(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:r,exclusive:a,reverse:c}=s;return So(it.Prod,o,t,r,a,c)}const Cm={kernelName:Ra,backendName:"webgl",kernelFunc:gm};/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function vm(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:r,exclusive:a,reverse:c}=s;return So(it.Sum,o,t,r,a,c)}const bm={kernelName:Sa,backendName:"webgl",kernelFunc:vm};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function $m(n){const{inputs:e,backend:t,attrs:s}=n,{x:o,weights:r}=e,{size:a,binaryOutput:c}=s;if(o.shape.length===1){const i=t.readSync(o.dataId),l=t.readSync(r.dataId),u=so(i,l,r.dtype,r.shape,a);return t.makeTensorInfo([a],r.dtype,u)}else if(o.shape.length===2){const i=t.bufferSync(o),l=t.bufferSync(r),u=Rd(i,l,a,c);return t.makeTensorInfo(u.shape,r.dtype,u.values)}throw new Error(`Error in denseBincount: input must be at most rank 2, but got rank${o.shape.length}.`)}const wm={kernelName:ya,backendName:"webgl",kernelFunc:$m};/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class Rm{constructor(e,t,s){this.variableNames=["x"],this.outputShape=[],this.outputShape=e,this.blockSize=t,this.dataFormat=s,this.userCode=`
    void main() {
      ivec4 coords = getOutputCoords();
      int b = coords[0];
 ...
 * limitations under the License.
 * =============================================================================
 */function Sm(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{blockSize:r,dataFormat:a}=s,c=o.shape[0],i=a==="NHWC"?o.shape[1]:o.shape[2],l=a==="NHWC"?o.shape[2]:o.shape[3],u=a==="NHWC"?o.shape[3]:o.shape[1],d=i*r,p=l*r,h=u/(r*r),f=a==="NHWC"?[c,d,p,h]:[c,h,d,p],g=new Rm(f,r,a);return t.runWebGLProgram(g,[o],o.dtype)}const ym={kernelName:Ia,backendName:"webgl",kernelFunc:Sm};/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class Em{constructor(e){this.variableNames=["x","dy"],this.outputShape=e.filterShape;const t=e.strideHeight,s=e.strideWidth,o=e.padInfo.top,r=e.padInfo.left,a=e.outChannels/e.inChannels;this.userCode=`
      void main() {
        ivec4 coords = getOutputCoords();
        int wR = coords.x;
        int wC = coords.y;
 ...
 * limitations under the License.
 * =============================================================================
 */function km(n){const{inputs:e,backend:t,attrs:s}=n,{x:o,dy:r}=e,{strides:a,dilations:c,pad:i,dimRoundingMode:l,filterShape:u}=s,d=be(o.shape,u,a,c,i,l,!0),p=new Em(d);return t.runWebGLProgram(p,[o,r],"float32")}const Om={kernelName:Ea,backendName:"webgl",kernelFunc:km};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Pm(n){const{inputs:e,backend:t,attrs:s}=n,{dy:o,filter:r}=e,{strides:a,dilations:c,pad:i,dimRoundingMode:l,inputShape:u}=s,d=be(u,r.shape,a,c,i,l,!0),p=new Nm(d);return t.runWebGLProgram(p,[o,r],"float32")}const Dm={kernelName:Na,backendName:"webgl",kernelFunc:Pm};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class Am{constructor(e){this.variableNames=["X"],this.outputShape=[e,e],this.userCode=`
      void main() {
          ivec2 coords = getOutputCoords();
 ...
 * limitations under the License.
 * =============================================================================
 */function Fm(n){const{inputs:e,backend:t}=n,{x:s}=e,o=[...s.shape,...s.shape],r=T(s.shape),a=R({inputs:{x:s},backend:t,attrs:{shape:[r]}}),c=new Am(r),i=t.runWebGLProgram(c,[a],a.dtype),l=R({inputs:{x:i},backend:t,attrs:{shape:o}});return t.disposeIntermediateTensorInfo(a),t.disposeIntermediateTensorInfo(i),l}const _m={kernelName:ka,backendName:"webgl",kernelFunc:Fm};/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class Lm{constructor(e){this.variableNames=["x","W"],this.outputShape=e.outShape;const{inHeight:t,inWidth:s,padInfo:o,strideHeight:r,strideWidth:a,filterHeight:c,filterWidth:i,dilationHeight:l,dilationWidth:u}=e,{top:d,left:p}=o;this.userCode=`
 ...
 * limitations under the License.
 * =============================================================================
 */function Bm(n){const{inputs:e,backend:t,attrs:s}=n,{x:o,filter:r}=e,{strides:a,pad:c,dilations:i}=s,l=Pa(o.shape,r.shape,a,c,"NHWC",i);let u;const d=new Lm(l);u=t.runWebGLProgram(d,[o,r],"float32");const p=R({inputs:{x:u},backend:t,attrs:{shape:l.outShape}});return t.disposeIntermediateTensorInfo(u),p}const Vm={kernelName:Oa,backendName:"webgl",kernelFunc:Bm};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Mm="return (x >= 0.0) ? x : (exp(x) - 1.0);",Gm=`
  vec4 result;
  ...
  return result;
`,zm=P({opSnippet:Mm,packedOpSnippet:Gm}),Hm={kernelName:Va,backendName:"webgl",kernelFunc:zm};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Xm="return (b >= 0.0) ? a : a * (b + 1.0);",Km=`
  vec4 bGTEZero = vec4(greaterThanEqual(b, vec4(0.)));
  return (bGTEZero * a) + ((vec4(1.0) - bGTEZero) * (a * (b + vec4(1.0))));
`,jm=n=>{const{inputs:e,backend:t}=n,{dy:s,y:o}=e,r=$().getBool("WEBGL_PACK_BINARY_OPERATIONS")?new Xe(Km,s.shape,o.shape):new Ne(Xm,s.shape,o.shape);return t.runWebGLProgram(r,[s,o],s.dtype)},qm={kernelName:Ua,backendName:"webgl",kernelFunc:jm};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,Qm="return float(a == b);",Zm=B({opSnippet:Qm,packedOpSnippet:Ym,dtype:"bool",cpuKernelImpl:Ed}),Jm={kernelName:Wa,backendName:"webgl",kernelFunc:Zm};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,tx=P({opSnippet:ex}),nx={kernelName:Ma,backendName:"webgl",kernelFunc:tx};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,ox=`
  ...
  return result;
`,To=P({opSnippet:sx,packedOpSnippet:ox,cpuKernelImpl:Nd,dtype:"float32"}),rx={kernelName:qa,backendName:"webgl",kernelFunc:To};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Zt(n){const{inputs:e,attrs:t,backend:s}=n,{dim:o}=t,{input:r}=e,a=r.shape.length,c=r.shape.slice();let i=o;return o<0&&(F(-(a+1)<=o,()=>`Axis must be in the interval [${-(a+1)}, ${a}]`),i=a+o+1),c.splice(i,0,1),R({inputs:{x:r},backend:s,attrs:{shape:c}})}const ax={kernelName:Ya,backendName:"webgl",kernelFunc:Zt};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const qn="return exp(x) - 1.0;",ix=P({opSnippet:qn,packedOpSnippet:qn,cpuKernelImpl:kd}),cx={kernelName:Qa,backendName:"webgl",kernelFunc:ix};/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function lx(n){const{inputs:e,backend:t}=n,{input:s}=e;return Eo(s,!1,t)}const ux={kernelName:Za,backendName:"webgl",kernelFunc:lx};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class dx{constructor(e,t){this.outputShape=[],this.customUniforms=[{name:"value",type:"float"}],this.variableNames=["x"],this.outputShape=e,this.userCode=`
      void main() {
 ...
 * limitations under the License.
 * =============================================================================
 */function ht(n){const{backend:e,attrs:t}=n,{shape:s,value:o}=t;let{dtype:r}=t;if(r=r||ei(o),r==="string"){const a=V(r,T(s));return a.fill(o),e.makeTensorInfo(s,r,a)}else{const a=new dx(s,o),c=[[o]];return e.runWebGLProgram(a,[],r,c)}}const px={kernelName:Ja,backendName:"webgl",kernelFunc:ht};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class hx{constructor(e){this.variableNames=["Image"],this.outputShape=[];const t=e[2];this.outputShape=e,this.userCode=`
        void main() {
          ivec4 coords = getOutputCoords();
          int x = coords[2];
 ...
 * limitations under the License.
 * =============================================================================
 */const fx={kernelName:ti,backendName:"webgl",kernelFunc:({inputs:n,backend:e})=>{const{image:t}=n,s=e,o=new hx(t.shape);return s.runWebGLProgram(o,[t],t.dtype)}};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Qn="return floor(x);",mx=P({opSnippet:Qn,packedOpSnippet:Qn,cpuKernelImpl:Od}),xx={kernelName:ni,backendName:"webgl",kernelFunc:mx};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,Cx=`
  ...
  return vec4(result);
`,vx=B({opSnippet:gx,packedOpSnippet:Cx,dtype:"int32"}),bx={kernelName:si,backendName:"webgl",kernelFunc:vx};/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class $x{constructor(e){this.variableNames=["A"];const t=z(),[s,o]=e;this.outputShape=e,this.userCode=`
      void main() {
        ivec3 coords = getOutputCoords();
        int texR = coords[0];
        int texC = coords[1];
 ...
 * limitations under the License.
 * =============================================================================
 */class Px{constructor(e,t){this.variableNames=["A","indices"],this.outputShape=t,this.rank=t.length;const s=D(this.rank),o=Dx(e);this.userCode=`
      void main() {
 ...
 * limitations under the License.
 * =============================================================================
 */const Fx="return float(a > b);",_x=`
  return vec4(greaterThan(a, b));
`,Lx=B({opSnippet:Fx,packedOpSnippet:_x,cpuKernelImpl:Ad,dtype:"bool"}),Bx={kernelName:di,backendName:"webgl",kernelFunc:Lx};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Vx="return float(a >= b);",Ux=`
  return vec4(greaterThanEqual(a, b));
`,Wx=B({opSnippet:Vx,packedOpSnippet:Ux,dtype:"bool",cpuKernelImpl:Fd}),Mx={kernelName:pi,backendName:"webgl",kernelFunc:Wx};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Gx(n){const{inputs:e,backend:t}=n,{input:s}=e;return Eo(s,!0,t)}const zx={kernelName:hi,backendName:"webgl",kernelFunc:Gx};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Hx="return float(!isnan(x) && !isinf(x));",Xx=P({opSnippet:Hx,dtype:"bool"}),Kx={kernelName:fi,backendName:"webgl",kernelFunc:Xx};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const jx="return float(isinf(x));",qx=P({opSnippet:jx,dtype:"bool"}),Yx={kernelName:mi,backendName:"webgl",kernelFunc:qx};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Qx="return float(isnan(x));",Zx=P({opSnippet:Qx,dtype:"bool"}),Jx={kernelName:xi,backendName:"webgl",kernelFunc:Zx};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const eg="return float(a < b);",tg=`
  return vec4(lessThan(a, b));
`,ng=B({opSnippet:eg,packedOpSnippet:tg,cpuKernelImpl:_d,dtype:"bool"}),sg={kernelName:gi,backendName:"webgl",kernelFunc:ng};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const og="return float(a <= b);",rg=`
  return vec4(lessThanEqual(a, b));
`,ag=B({opSnippet:og,packedOpSnippet:rg,cpuKernelImpl:Ld,dtype:"bool"}),ig={kernelName:Ci,backendName:"webgl",kernelFunc:ag};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function cg(n){const{backend:e,attrs:t}=n,{start:s,stop:o,num:r}=t,a=Bd(s,o,r);return e.makeTensorInfo([a.length],"float32",a)}const lg={kernelName:vi,backendName:"webgl",kernelFunc:cg};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,dg=`
  ...
  return result;
`,pg=P({opSnippet:ug,packedOpSnippet:dg,cpuKernelImpl:Vd}),hg={kernelName:bi,backendName:"webgl",kernelFunc:pg};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */const fg=Ke+`
  return log(1.0 + x);
`,mg=P({opSnippet:fg}),xg={kernelName:$i,backendName:"webgl",kernelFunc:mg};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const gg="return float(a >= 1.0 && b >= 1.0);",Cg=`
  return vec4(
    vec4(greaterThanEqual(a, vec4(1.0))) *
    vec4(greaterThanEqual(b, vec4(1.0))));
`,vg=B({opSnippet:gg,packedOpSnippet:Cg,dtype:"bool"}),bg={kernelName:wi,backendName:"webgl",kernelFunc:vg};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const $g="return float(!(x >= 1.0));",wg=P({opSnippet:$g}),Rg={kernelName:Ri,backendName:"webgl",kernelFunc:wg};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Sg="return float(a >= 1.0 || b >= 1.0);",yg=`
  return min(
    vec4(greaterThanEqual(a, vec4(1.0))) +
    vec4(greaterThanEqual(b, vec4(1.0))),
    vec4(1.0));
`,Ig=B({opSnippet:Sg,packedOpSnippet:yg,dtype:"bool"}),Tg={kernelName:Si,backendName:"webgl",kernelFunc:Ig};/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class Eg{constructor(e,t,s,o,r){this.variableNames=["x"],this.outputShape=[];const a=t,c=e[3]-1;this.outputShape=e;let i;const l=`float(${s}) + float(${o}) * sum`;r===.5?i=`inversesqrt(${l})`:r===1?i=`1.0/(${l})`:i=`exp(log(${l}) * float(-${r}));`,this.userCode=`
      void main() {
        ivec4 coords = getOutputCoords();
        int b = coords[0];
        int r = coords[1];
 ...
 * limitations under the License.
 * =============================================================================
 */const kg=n=>{const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{depthRadius:r,bias:a,alpha:c,beta:i}=s,l=$().getBool("WEBGL_PACK_NORMALIZATION")?new Ng(o.shape,r,a,c,i):new Eg(o.shape,r,a,c,i);return t.runWebGLProgram(l,[o],o.dtype)},Og={kernelName:yi,backendName:"webgl",kernelFunc:kg};/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Dg=n=>{const{inputs:e,backend:t,attrs:s}=n,{x:o,y:r,dy:a}=e,{depthRadius:c,bias:i,alpha:l,beta:u}=s,d=new Pg(o.shape,c,i,l,u);return t.runWebGLProgram(d,[o,r,a],o.dtype)},Ag={kernelName:Ii,backendName:"webgl",kernelFunc:Dg};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Fg(n,e,t,s){const o=T(e),a=T(n.shape)/o,c=R({inputs:{x:n},attrs:{shape:[a,o]},backend:s}),i=Ae(c,n.dtype,"max",s),l=R({inputs:{x:i},attrs:{shape:t},backend:s});return s.disposeIntermediateTensorInfo(c),s.disposeIntermediateTensorInfo(i),l}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,Bg=`
  ...
  `+De+`
  return result;
`,Vg=B({opSnippet:Lg,packedOpSnippet:Bg,cpuKernelImpl:Wd}),Ug={kernelName:Ei,backendName:"webgl",kernelFunc:Vg};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Gg(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{filterSize:r,strides:a,pad:c,dataFormat:i,dimRoundingMode:l}=s,u=[1,1,1],d=Ot(o.shape,r,a,u,c,l,i),p=new bn(d,"max",!1);return t.runWebGLProgram(p,[o],o.dtype)}const zg={kernelName:ki,backendName:"webgl",kernelFunc:Gg};/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class Hg{constructor(e){this.variableNames=["dy","maxPos"],this.outputShape=e.inShape;const t=e.strideHeight,s=e.strideWidth,o=e.dilationHeight,r=e.effectiveFilterHeight,a=e.effectiveFilterWidth,c=r-1-e.padInfo.top,i=a-1-e.padInfo.left,l=r*a-1;this.userCode=`
      const ivec2 pads = ivec2(${c}, ${i});
 ...
 * limitations under the License.
 * =============================================================================
 */function qg(n){const{inputs:e,backend:t,attrs:s}=n,{dy:o,input:r,output:a}=e,c=r;We([r,a],"maxPoolGrad");const{filterSize:i,strides:l,pad:u,dimRoundingMode:d}=s,p=lt(c.shape,i,l,1,u,d),h=!0,f=new at(p,"max",h),g=t.runWebGLProgram(f,[c],c.dtype),x=new Hg(p),m=t.runWebGLProgram(x,[o,g],c.dtype);return t.disposeIntermediateTensorInfo(g),m}const Yg={kernelName:Pi,backendName:"webgl",kernelFunc:qg};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Jg(n,e,t,s){const o=T(e),a=T(n.shape)/o,c=R({inputs:{x:n},attrs:{shape:[a,o]},backend:s}),i=Ae(c,"float32","mean",s),l=R({inputs:{x:i},attrs:{shape:t},backend:s});return s.disposeIntermediateTensorInfo(c),s.disposeIntermediateTensorInfo(i),l}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function tC(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:r,keepDims:a}=s,c=o.shape.length,i=K(r,o.shape);let l=i;const u=ie(l,c);let d=o;u!=null&&(d=G({inputs:{x:o},backend:t,attrs:{perm:u}}),l=ce(l.length,o.shape.length)),de("min",l,c);const[p,h]=pe(d.shape,l),f=T(h),g=R({inputs:{x:d},backend:t,attrs:{shape:[-1,f]}}),x=Ae(g,g.dtype,"min",t);let m;if(a){const C=ve(p,i);m=R({inputs:{x},backend:t,attrs:{shape:C}})}else m=R({inputs:{x},backend:t,attrs:{shape:p}});return t.disposeIntermediateTensorInfo(g),t.disposeIntermediateTensorInfo(x),u!=null&&t.disposeIntermediateTensorInfo(d),m}const nC={kernelName:Fi,backendName:"webgl",kernelFunc:tC};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,oC=`
  ...
  `+De+`
  return result;
`,rC=B({opSnippet:sC,packedOpSnippet:oC,cpuKernelImpl:Md}),aC={kernelName:_i,backendName:"webgl",kernelFunc:rC};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class iC{constructor(e,t,s){this.variableNames=["x"],this.outputShape=t.map((u,d)=>u[0]+e[d]+u[1]);const o=e.length,r=D(o),a=t.map(u=>u[0]).join(","),c=t.map((u,d)=>u[0]+e[d]).join(","),i=["coords[0]","coords[1]","coords[2]","coords[3]"].slice(0,o),l=s==="reflect"?0:1;if(o===1){this.userCode=`
        int start = ${a};
        int end = ${c};
 ...
 * limitations under the License.
 * =============================================================================
 */const lC=({inputs:n,backend:e,attrs:t})=>{const{x:s}=n,{paddings:o,mode:r}=t,a=$().getBool("WEBGL_PACK_ARRAY_OPERATIONS")?new cC(s.shape,o,r):new iC(s.shape,o,r);return e.runWebGLProgram(a,[s],s.dtype)},uC={kernelName:Li,backendName:"webgl",kernelFunc:lC};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const dC=`if (b == 0.0) return NAN;
  return mod(a, b);`,pC=`
  vec4 result = mod(a, b);
  bvec4 isNaN = equal(b, vec4(0.0));
  `+De+`
  return result;
`,hC=B({opSnippet:dC,packedOpSnippet:pC}),fC={kernelName:Bi,backendName:"webgl",kernelFunc:hC};/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class mC{constructor(e,t,s){this.variableNames=["probs"],this.customUniforms=[{name:"seed",type:"float"}],this.outputShape=[e,s],this.userCode=`
      void main() {
        ivec2 coords = getOutputCoords();
        int batch = coords[0];
...
return a / b;`,gC=`
  ...
  return result;
`,Oo=B({opSnippet:xC,packedOpSnippet:gC,checkOutOfBounds:!0}),CC={kernelName:Vi,backendName:"webgl",kernelFunc:Oo};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Zn="return a - b;",Po=B({opSnippet:Zn,packedOpSnippet:Zn,supportsComplex:!0,cpuKernelImpl:lp}),vC={kernelName:Ui,backendName:"webgl",kernelFunc:Po};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Do(n){const{inputs:e,backend:t,attrs:s}=n,{logits:o}=e,{dim:r}=s,a=K([r],o.shape),c=ko({inputs:{x:o},backend:t,attrs:{reductionIndices:a,keepDims:!1}}),i=ve(c.shape,a),l=R({inputs:{x:c},backend:t,attrs:{shape:i}}),u=Po({inputs:{a:o,b:l},backend:t}),d=To({inputs:{x:u},backend:t}),p=_t({inputs:{x:d},backend:t,attrs:{axis:a,keepDims:!1}}),h=R({inputs:{x:p},backend:t,attrs:{shape:i}}),f=Oo({inputs:{a:d,b:h},backend:t});return t.disposeIntermediateTensorInfo(c),t.disposeIntermediateTensorInfo(l),t.disposeIntermediateTensorInfo(u),t.disposeIntermediateTensorInfo(d),t.disposeIntermediateTensorInfo(p),t.disposeIntermediateTensorInfo(h),f}const bC={kernelName:Wi,backendName:"webgl",kernelFunc:Do};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function $C(n){const{inputs:e,backend:t,attrs:s}=n,{logits:o}=e,{numSamples:r,seed:a,normalized:c}=s,i=c?o:Do({inputs:{logits:o},backend:t,attrs:{dim:o.shape.length-1}}),l=i.shape[0],u=i.shape[1],d=new mC(l,u,r),p=[[a]],h=t.runWebGLProgram(d,[i],"int32",p);return c||t.disposeIntermediateTensorInfo(i),h}const wC={kernelName:Mi,backendName:"webgl",kernelFunc:$C};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class _C{constructor(e,t,s,o){this.variableNames=["indices"],this.outputShape=[e,t],this.userCode=`
      void main() {
        ivec2 coords = getOutputCoords();
 ...
 * limitations under the License.
 * =============================================================================
 */const LC=n=>{const{inputs:e,backend:t,attrs:s}=n,{indices:o}=e,{dtype:r,depth:a,onValue:c,offValue:i}=s,l=T(o.shape),u=new _C(l,a,c,i),d=R({inputs:{x:o},backend:t,attrs:{shape:[l]}}),p=t.runWebGLProgram(u,[d],r);t.disposeIntermediateTensorInfo(d);const h=[...o.shape,a],f=R({inputs:{x:p},backend:t,attrs:{shape:h}});return t.disposeIntermediateTensorInfo(p),f},BC={kernelName:Yi,backendName:"webgl",kernelFunc:LC};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function WC(n){const{inputs:e,backend:t,attrs:s}=n,{axis:o}=s;if(e.length===1)return Zt({inputs:{input:e[0]},backend:t,attrs:{dim:o}});const r=e[0].shape,a=e[0].dtype;e.forEach(u=>{ec(r,u.shape,"All tensors passed to stack must have matching shapes"),F(a===u.dtype,()=>"All tensors passed to stack must have matching dtypes")});const c=[],i=e.map(u=>{const d=Zt({inputs:{input:u},backend:t,attrs:{dim:o}});return c.push(d),d}),l=vo({inputs:i,backend:t,attrs:{axis:o}});return c.forEach(u=>t.disposeIntermediateTensorInfo(u)),l}const MC={kernelName:Ji,backendName:"webgl",kernelFunc:WC};/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class GC{constructor(e,t,s){this.variableNames=["x"],this.customUniforms=[{name:"value",type:"float"}],this.outputShape=t.map((l,u)=>l[0]+e[u]+l[1]);const o=e.length,r=D(o),a=t.map(l=>l[0]).join(","),c=t.map((l,u)=>l[0]+e[u]).join(","),i=["coords[0]","coords[1]","coords[2]","coords[3]"].slice(0,o);if(o===1){this.userCode=`
        int start = ${a};
        int end = ${c};
...
`,KC=`
  ...
  `+De+`
  return result;
`,jC=B({opSnippet:XC,packedOpSnippet:KC}),qC={kernelName:nc,backendName:"webgl",kernelFunc:jC};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function YC(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{axis:r,keepDims:a}=s,c=o.shape.length,i=[],l=K(r,o.shape);let u=l;const d=ie(u,c);let p=o;d!=null&&(p=G({inputs:{x:o},backend:t,attrs:{perm:d}}),u=ce(u.length,c),i.push(p)),de("prod",u,c);let h;if(t.shouldExecuteOnCPU([p])){const f=t.texData.get(p.dataId).values,{outVals:g,outShape:x,outDtype:m}=Xd(p.shape,p.dtype,f,u);h=t.makeTensorInfo(x,m,g)}else{const[f,g]=pe(p.shape,u),x=T(g),m=R({inputs:{x:p},backend:t,attrs:{shape:[-1,x]}}),C=sn(o.dtype),b=Ae(m,C,"prod",t);h=R({inputs:{x:b},backend:t,attrs:{shape:f}}),i.push(m),i.push(b)}if(a){i.push(h);const f=ve(h.shape,l);h=R({inputs:{x:h},backend:t,attrs:{shape:f}})}return i.forEach(f=>t.disposeIntermediateTensorInfo(f)),h}const QC={kernelName:sc,backendName:"webgl",kernelFunc:YC};/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const _o=n=>{const{backend:e,attrs:t}=n,{start:s,stop:o,step:r,dtype:a}=t,c=Yd(s,o,r,a);return e.makeTensorInfo([c.length],a,c)},o0={kernelName:ic,backendName:"webgl",kernelFunc:_o};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const r0="return 1.0 / x;",a0=P({opSnippet:r0}),i0={kernelName:cc,backendName:"webgl",kernelFunc:a0};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,l0=`
  ...
  return result;
`,u0=P({opSnippet:c0,packedOpSnippet:l0}),d0={kernelName:lc,backendName:"webgl",kernelFunc:u0};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,h0=`
  ...
  return result;
`,f0=P({opSnippet:p0,packedOpSnippet:h0}),m0={kernelName:uc,backendName:"webgl",kernelFunc:f0};/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class x0{constructor(e,t,s,o,r){this.variableNames=["A"],this.outputShape=[];const[a,c,i,l]=e;this.outputShape=[a,t,s,l];const u=[o&&t>1?c-1:c,o&&s>1?i-1:i],d=[o&&t>1?t-1:t,o&&s>1?s-1:s];let p;r?p="(vec2(yRC) + vec2(0.5)) * effectiveInputOverOutputRatioRC - vec2(0.5)":p="vec2(yRC) * effectiveInputOverOutputRatioRC",this.userCode=`
 ...
 * limitations under the License.
 * =============================================================================
 */function C0(n){const{inputs:e,backend:t,attrs:s}=n,{images:o}=e,{alignCorners:r,halfPixelCenters:a,size:c}=s,[i,l]=c,u=$().getBool("WEBGL_PACK_IMAGE_OPERATIONS")?new g0(o.shape,i,l,r,a):new x0(o.shape,i,l,r,a);return t.runWebGLProgram(u,[o],"float32")}const v0={kernelName:dc,backendName:"webgl",kernelFunc:C0};/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class b0{constructor(e,t,s){this.variableNames=["dy"],this.outputShape=[],this.outputShape=t;const[,o,r]=t,[,a,c]=e,i=[s&&a>1?o-1:o,s&&c>1?r-1:r],l=[s&&a>1?a-1:a,s&&c>1?c-1:c],u=i[0]/l[0],d=i[1]/l[1],p=1/u,h=1/d,f=Math.ceil(p)*2+2,g=Math.ceil(h)*2+2;this.userCode=`
      void main() {
        ivec4 coords = getOutputCoords();
        int b = coords[0];
        int d = coords[3];
 ...
 * limitations under the License.
 * =============================================================================
 */function $0(n){const{inputs:e,backend:t,attrs:s}=n,{images:o,dy:r}=e,{alignCorners:a}=s,c=new b0(r.shape,o.shape,a);return t.runWebGLProgram(c,[r],r.dtype)}const w0={kernelName:pc,backendName:"webgl",kernelFunc:$0};/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function y0(n){const{inputs:e,backend:t,attrs:s}=n,{images:o}=e,{alignCorners:r,halfPixelCenters:a,size:c}=s,[i,l]=c,u=$().getBool("WEBGL_PACK_IMAGE_OPERATIONS")?new S0(o.shape,i,l,r,a):new R0(o.shape,i,l,r,a);return t.runWebGLProgram(u,[o],o.dtype)}const I0={kernelName:hc,backendName:"webgl",kernelFunc:y0};/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class T0{constructor(e,t,s){this.variableNames=["dy"],this.outputShape=[],this.outputShape=t;const[,o,r]=t,[,a,c]=e,i=[s&&a>1?o-1:o,s&&c>1?r-1:r],l=[s&&a>1?a-1:a,s&&c>1?c-1:c],u=i[0]/l[0],d=i[1]/l[1],p=1/u,h=1/d,f=Math.ceil(p)*2+2,g=Math.ceil(h)*2+2;this.userCode=`
      void main() {
        ivec4 coords = getOutputCoords();
        int b = coords[0];
        int d = coords[3];
 ...
 * limitations under the License.
 * =============================================================================
 */function E0(n){const{inputs:e,backend:t,attrs:s}=n,{images:o,dy:r}=e,{alignCorners:a}=s,c=new T0(r.shape,o.shape,a);return t.runWebGLProgram(c,[r],r.dtype)}const N0={kernelName:fc,backendName:"webgl",kernelFunc:E0};/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class k0{constructor(e,t){this.variableNames=["x"];const s=e.length;if(s>4)throw new Error(`WebGL backend: Reverse of rank-${s} tensor is not yet supported`);if(this.outputShape=e,s===1){this.userCode=`
        void main() {
 ...
 * limitations under the License.
 * =============================================================================
 */function P0(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{dims:r}=s,a=o.shape.length,c=K(r,o.shape);if(a===0)return Q({inputs:{x:o},backend:t});const i=$().getBool("WEBGL_PACK_ARRAY_OPERATIONS")?new O0(o.shape,c):new k0(o.shape,c);return t.runWebGLProgram(i,[o],o.dtype)}const D0={kernelName:mc,backendName:"webgl",kernelFunc:P0};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class A0{constructor(e,t){this.variableNames=["Image"],this.outputShape=[],this.customUniforms=[{name:"params",type:"vec4"}];const s=e[1],o=e[2];this.outputShape=e;let r="";typeof t=="number"?r=`float outputValue = ${t.toFixed(2)};`:r=`
 ...
 * limitations under the License.
 * =============================================================================
 */const F0={kernelName:xc,backendName:"webgl",kernelFunc:({inputs:n,attrs:e,backend:t})=>{const{image:s}=n,{radians:o,fillValue:r,center:a}=e,c=t,i=new A0(s.shape,r),[l,u]=gc(a,s.shape[1],s.shape[2]),d=[[l,u,Math.sin(o),Math.cos(o)]];return c.runWebGLProgram(i,[s],s.dtype,d)}};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,L0=P({opSnippet:_0}),B0={kernelName:Cc,backendName:"webgl",kernelFunc:L0};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const V0="return inversesqrt(x);",U0=P({opSnippet:V0,cpuKernelImpl:Qd}),W0={kernelName:vc,backendName:"webgl",kernelFunc:U0};/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class H0{constructor(e,t,s,o){this.variableNames=["sortedSequence","values"],this.customUniforms=[{name:"numInputs",type:"int"}],this.outputShape=[e,s];const r="while (left < right) {",a=`for (int i = 0; i < ${Math.ceil(Math.log2(t+1))}; ++i) { if (left >= right) break;`,c=$().getNumber("WEBGL_VERSION")===2?r:a,i=o==="left"?"<":"<=";this.userCode=`
 ...
 * limitations under the License.
 * =============================================================================
 */function X0(n){const{inputs:e,backend:t,attrs:s}=n,{sortedSequence:o,values:r}=e,{side:a}=s,c=new H0(o.shape[0],o.shape[1],r.shape[1],a),i=[[o.shape[1]]];return t.runWebGLProgram(c,[o,r],"int32",i)}const K0={kernelName:$c,backendName:"webgl",kernelFunc:X0};/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function q0(n){const{inputs:e,backend:t}=n,{condition:s,t:o,e:r}=e,a=new j0(s.shape.length,o.shape,o.shape.length);return t.runWebGLProgram(a,[s,o,r],Ie(o.dtype,r.dtype))}const Y0={kernelName:wc,backendName:"webgl",kernelFunc:q0};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,Z0=P({opSnippet:Q0}),J0={kernelName:Rc,backendName:"webgl",kernelFunc:Z0};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,tv=`
  ...
  return result;
`,nv=P({opSnippet:ev,packedOpSnippet:tv,cpuKernelImpl:Jd}),sv={kernelName:Ic,backendName:"webgl",kernelFunc:nv};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */const ov=`
  ...
  return sign(x);
`,rv=P({opSnippet:ov}),av={kernelName:Tc,backendName:"webgl",kernelFunc:rv};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,cv=`
  ...
  ${De}
  return result;
`,lv=P({opSnippet:iv,packedOpSnippet:cv}),uv={kernelName:Ec,backendName:"webgl",kernelFunc:lv};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */const dv=`
  float e2x = exp(x);
  return (e2x - 1.0 / e2x) / 2.0;
`,pv=P({opSnippet:dv}),hv={kernelName:Nc,backendName:"webgl",kernelFunc:pv};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 */const fv=`
  ...
  return result;
`,mv=P({opSnippet:fv}),xv={kernelName:kc,backendName:"webgl",kernelFunc:mv};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function vv(n){const{inputs:e,backend:t}=n,{indices:s,values:o,denseShape:r,defaultValue:a}=e;if(r.shape.length!==1)throw new Error(`Dense shape must be a vector, saw:
 ...
 */function Rv(n){const{inputs:e,backend:t}=n,{data:s,indices:o,segmentIds:r}=e;if(s.shape.length<1)throw new Error("Data should be at least 1 dimensional but received scalar");if(o.shape.length!==1)throw new Error(`Indices should be a vector but received shape
              ...
              ${r.shape}`);const a=t.readSync(s.dataId),c=t.readSync(o.dataId),i=t.readSync(r.dataId),[l,u]=ro(a,s.shape,s.dtype,c,i,!0);return t.makeTensorInfo(u,s.dtype,l)}const Sv={kernelName:Ac,backendName:"webgl",kernelFunc:Rv};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function yv(n){const{inputs:e,backend:t}=n,{data:s,indices:o,segmentIds:r}=e;if(s.shape.length<1)throw new Error("Data should be at least 1 dimensional but received scalar");if(o.shape.length!==1)throw new Error(`Indices should be a vector but received shape
             ${o.shape}`);if(r.shape.length!==1)throw new Error(`Segment ids should be a vector but received shape
             ${r.shape}`);const a=t.readSync(s.dataId),c=t.readSync(o.dataId),i=t.readSync(r.dataId),[l,u]=ro(a,s.shape,s.dtype,c,i);return t.makeTensorInfo(u,s.dtype,l)}const Iv={kernelName:Fc,backendName:"webgl",kernelFunc:yv};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Nv(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e,{numOrSizeSplits:r,axis:a}=s,c=K(a,o.shape)[0],i=Bc(o,r,c),l=o.shape.length,u=new Array(l).fill(0),d=o.shape.slice();return i.map(p=>{const h=[...d];h[c]=p;const f=je({inputs:{x:o},backend:t,attrs:{begin:u,size:h}});return u[c]+=p,f})}const kv={kernelName:Lc,backendName:"webgl",kernelFunc:Nv};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Jn="return sqrt(x);",Ov=P({opSnippet:Jn,packedOpSnippet:Jn,cpuKernelImpl:sp}),Pv={kernelName:Vc,backendName:"webgl",kernelFunc:Ov};/**
 * @license
 * Copyright 2019 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Dv="return x * x;",Av=P({opSnippet:Dv}),Fv={kernelName:Uc,backendName:"webgl",kernelFunc:Av};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const es="return (a - b) * (a - b);",_v=B({opSnippet:es,packedOpSnippet:es}),Lv={kernelName:Wc,backendName:"webgl",kernelFunc:_v};/**
 * @license
 * Copyright 2023 Google LLC.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Bv(n){const{inputs:e,backend:t,attrs:s}=n,{x:o}=e;if(o.dtype!=="string")throw new Error("Input must be of datatype string");const r=t.readSync(o.dataId),a=nt(r),c=op(a,"string",s);return t.makeTensorInfo(o.shape,"string",c)}const Vv={kernelName:Mc,backendName:"webgl",kernelFunc:Bv};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function Uv({inputs:n,attrs:e,backend:t}){const{x:s}=n,o=oe+`
    return x > 0.0 ? 1.0 : float(${e.alpha});
  `,r=new ue(s.shape,o);return t.runWebGLProgram(r,[s],s.dtype)}const Wv={kernelName:Gc,backendName:"webgl",kernelFunc:Uv};/**
 * @license
 * Copyright 2017 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class Mv{constructor(e,t,s){this.variableNames=["x"],this.outputShape=s;const o=s.length,r=D(s.length),a=D(s.length);let c="";if(o===1)c="coords * strides + begin";else{let i=0;c=s.map((l,u)=>(i++,s.length===1?`coords * strides[${u}] + begin[${u}]`:`coords[${i-1}] * strides[${u}] + begin[${u}]`)).join(",")}this.userCode=`
      ${r} begin = ${r}(${e});
      ${r} strides = ${r}(${t});
 ...
 * limitations under the License.
 * =============================================================================
 */function Kv(n){const{inputs:e,backend:t,attrs:s}=n,{skipEmpty:o}=s,{input:r,delimiter:a}=e;if(r.dtype!=="string")throw new Error("Input must be of datatype string");if(r.shape.length!==1)throw new Error(`Input must be a vector, got shape: ${r.shape}`);if(a.shape.length!==0)throw new Error(`Delimiter must be a scalar, got shape: ${a.shape}`);const c=t.readSync(r.dataId),i=t.readSync(a.dataId)[0],[l,u,d]=ip(c,i,o),p=u.length;return[t.makeTensorInfo([p,2],"int32",l),t.makeTensorInfo([p],"string",u),t.makeTensorInfo([2],"int32",new Int32Array(d))]}const jv={kernelName:jc,backendName:"webgl",kernelFunc:Kv};/**
 * @license
 * Copyright 2021 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function qv(n){const{inputs:e,backend:t,attrs:s}=n,{numBuckets:o}=s,{input:r}=e;if(r.dtype!=="string")throw new Error("Input must be of datatype string");if(o<=0)throw new Error("Number of buckets must be at least 1");const a=t.readSync(r.dataId),c=cp(a,o);return t.makeTensorInfo(r.shape,"int32",c)}const Yv={kernelName:qc,backendName:"webgl",kernelFunc:qv};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */const Qv="return tan(x);",Zv=P({opSnippet:Qv}),Jv={kernelName:Yc,backendName:"webgl",kernelFunc:Zv};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
...
`,tb=P({opSnippet:eb}),nb={kernelName:Qc,backendName:"webgl",kernelFunc:tb};/**
 * @license
 * Copyright 2022 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class rb{constructor(e,t){this.variableNames=["A"];const s=new Array(e.length);for(let a=0;a<s.length;a++)s[a]=e[a]*t[a];this.outputShape=s,this.rank=s.length;const o=D(this.rank),r=ab(e);this.userCode=`
      void main() {
        ${o} resRC = getOutputCoords();
        setOutput(getA(${r}));
      }
    `}}function ab(n){const e=n.length;if(e>5)throw Error(`Tile for rank ${e} is not yet supported`);if(e===1)return`imod(resRC, ${n[0]})`;const t=["resRC.x","resRC.y","resRC.z","resRC.w","resRC.u"],s=[];for(let o=0;o<n.length;o++)s.push(`imod(${t[o]}, ${n[o]})`);return s.join()}/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class pb{constructor(e,t,s,o,r,a){this.variableNames=["Image","Transforms"],this.outputShape=a;const c=s==="nearest"?1:2;let i;switch(o){case"constant":i=1;break;case"reflect":i=2;break;case"wrap":i=3;break;case"nearest":i=4;break;default:i=1;break}this.userCode=`
 ...
 * limitations under the License.
 * =============================================================================
 */function hb(n){const{inputs:e,backend:t,attrs:s}=n,{image:o,transforms:r}=e,{interpolation:a,fillMode:c,fillValue:i,outputShape:l}=s,[u,d,p,h]=o.shape,[f,g]=l??[d,p],x=[u,f,g,h],m=new pb(d,p,a,c,i,x);return t.runWebGLProgram(m,[o,r],"float32")}const fb={kernelName:tl,backendName:"webgl",kernelFunc:hb};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the License);
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function mb(n){const{inputs:e,attrs:t,backend:s}=n,{axis:o}=t,{x:r}=e;We(r,"unique"),console.warn("WARNING: ","UI might be locked temporarily as data is being downloaded");const a=s.readSync(r.dataId),{outputValues:c,outputShape:i,indices:l}=pp(a,o,r.shape,r.dtype);return[s.makeTensorInfo(i,r.dtype,c),s.makeTensorInfo([l.length],"int32",l)]}const xb={kernelName:nl,backendName:"webgl",kernelFunc:mb};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */function gb(n){const{inputs:e,backend:t,attrs:s}=n,{value:o}=e;let{axis:r}=s;r<0&&(r+=o.shape.length);const a=o,c=a.shape.length,i=o.shape[r],l=new Array(c-1);let u=0;for(let g=0;g<c;g++)g!==r&&(l[u++]=a.shape[g]);const d=[],p=new Array(c).fill(0),h=a.shape.slice();h[r]=1;const f=new Array(i);for(let g=0;g<f.length;g++){p[r]=g;const x=je({inputs:{x:a},backend:t,attrs:{begin:p,size:h}}),m=R({inputs:{x},backend:t,attrs:{shape:l}});f[g]=m,d.push(x)}return d.forEach(g=>t.disposeIntermediateTensorInfo(g)),f}const Cb={kernelName:sl,backendName:"webgl",kernelFunc:gb};/**
 * @license
 * Copyright 2018 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
 ...
 * limitations under the License.
 * =============================================================================
 */class vb{constructor(e,t){this.variableNames=["x","segmentIds"];const s=e.windowSize,o=e.batchSize,r=e.inSize,a=e.numSegments,c=a*Math.ceil(r/s);this.outputShape=[o,c];const i="0.0",l="sumValue",u=Math.floor(s/4)*4,d=s%4,p=`
 ...
 * limitations under the License.
 * =============================================================================
 */function bb(n){const{inputs:e,backend:t,attrs:s}=n,{x:o,segmentIds:r}=e,{numSegments:a}=s,c=o.shape.length,i=[];let l=0;const u=ie([l],c);let d=o;u!=null&&(d=G({inputs:{x:o},backend:t,attrs:{perm:u}}),i.push(d),l=ce(1,c)[0]);const p=rl(d.shape,l,a),h=T([d.shape[l]]),f=R({inputs:{x:d},backend:t,attrs:{shape:[-1,h]}});i.push(f);const g=sn(o.dtype),x=(v,w,N,I,y)=>{const O=v.shape[0],k=v.shape[1],A=al(k,y),_={windowSize:A,inSize:k,batchSize:O,numSegments:y},le=new vb(_,w),q=t.compileAndRun(le,[v,N],I);if(i.push(q),q.shape[1]===y)return q;const Z=_o({backend:t,attrs:{start:0,stop:y,step:1,dtype:"float32"}}),ne=Lo({inputs:{x:Z},backend:t,attrs:{reps:[k/A]}});return i.push(Z),i.push(ne),x(q,w,ne,I,y)},m=x(f,"unsortedSegmentSum",r,g,a),C=R({inputs:{x:m},backend:t,attrs:{shape:p}});let b=C;if(u!=null){i.push(C);const v=ls(u);b=G({inputs:{x:b},backend:t,attrs:{perm:v}})}return i.forEach(v=>t.disposeIntermediateTensorInfo(v)),b}const $b={kernelName:ol,backendName:"webgl",kernelFunc:bb};/**
 * @license
 * Copyright 2020 Google LLC. All Rights Reserved.
 * Licensed under the Apache License, Version 2.0 (the "License");
 * you may not use this file except in compliance with the License.
