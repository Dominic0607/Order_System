                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        ...
                        <button 
                            onClick={async () => {
                                ...
                                if (granted) {
                                    sendSystemNotification("Test Notification", "This is a test notification from the system.");
                                } else {
                                    alert("Notification permission denied or ignored.");
                                }
                            }}
                            className="py-3 bg-pink-600/10 border border-pink-500/30 text-pink-400 rounded-xl font-black uppercase text-[10px] tracking-widest hover:bg-pink-600 hover:text-white transition-all flex items-center justify-center gap-2 active:scale-95"
                        >
